...
⏲ there have been `152` posts within the `last 24 hours`

🦈 there have been `211` posts within the `month of october`

🪐 there have been `1225` posts within the `last 90 days`

🏚 there have been `1265` posts within the `year of 2021`

🦕 there have been `1299` posts `since the dawn of ransomwatch`
