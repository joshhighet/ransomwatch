...
🦈 there have been `434` posts within the `month of october`

🪐 there have been `1446` posts within the `last 90 days`

🏚 there have been `1488` posts within the `year of 2021`

🦕 there have been `1522` posts `since the dawn of ransomwatch`
...
| lockbit2 | Start-maximized.com | ⬆️ 🟢 |  | zqaflhty5hyziovsxgqvj2mrz5e5rs6oqxzb54zolccfnvtn5w2johad.onion |
