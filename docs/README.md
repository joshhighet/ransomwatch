...
⏲ there have been `153` posts within the `last 24 hours`

🦈 there have been `212` posts within the `month of october`

🪐 there have been `1226` posts within the `last 90 days`

🏚 there have been `1266` posts within the `year of 2021`

🦕 there have been `1300` posts `since the dawn of ransomwatch`
