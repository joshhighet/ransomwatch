...
⏲ there have been `163` posts within the `last 24 hours`

🦈 there have been `225` posts within the `month of october`

🪐 there have been `1239` posts within the `last 90 days`

🏚 there have been `1279` posts within the `year of 2021`

🦕 there have been `1313` posts `since the dawn of ransomwatch`
